 ...
 const navigate =  useNavigate()
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      setLoading(true);
      fetch('http://localhost:9091/auth/user/login', {
        method: 'POST',
      ...
      <div className="container bg-white  shadow-1 p-4 mt-40" style={{ borderRadius: 20 }}>
        <div className="row justify-between">
          ...
          <div className="col-xl-6 col-lg-7 col-md-9 ">
            <img src="img/login/login-bg.jpg" className="w-100 h-full img-cover" style={{ borderTopRightRadius: 20, borderBottomRightRadius: 20 }} />
          </div>
        </div>
      </div>
    </section>
